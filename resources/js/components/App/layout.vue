                ...
                window.innerWidth < 991
                    ? total.forEach(function (t, e) {
                          if (!t.classList.contains("flex-column")) {
                              ...
                              (i.style.width =
                                  t.querySelector("li:nth-child(1)")
                                      .offsetWidth + "px"),
                                  (i.style.transform =
                                      "translate3d(0px," + e + "px, 0px)");
                          }
                ...
                s[t].addEventListener(
                    ...
                    function (e) {
                        ...
                        (s = document.createElement("span")).classList.add(
                            ...
                            t.appendChild(s),
                            (s.style.left =
                                e.offsetX - s.offsetWidth / 2 + "px"),
                            (s.style.top =
                                e.offsetY - s.offsetHeight / 2 + "px"),
    ...
    function darkMode(e) {
        ...
        if (e.getAttribute("checked")) {
            ...
            for (y = 0; y < L.length; y++)
                L[y].hasAttribute("fill") &&
                    L[y].setAttribute("fill", "#252f40");
